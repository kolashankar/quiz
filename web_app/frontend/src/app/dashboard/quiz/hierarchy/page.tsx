        ...
        <div className="space-y-4">
          {items.map((item) => (
            <Card key={item.id} padding="none">
              <button
                ...
                className="w-full p-4 flex items-center hover:bg-gray-50 transition text-left"
              >
          ...
          {items.length === 0 && (
            <Card className="text-center py-12">
              ...
              <p className="text-gray-600">Content will appear here once it's added to the system.</p>
            </Card>
          )}
        </div>
      </div>
